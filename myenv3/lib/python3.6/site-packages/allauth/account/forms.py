...
class ChangePasswordForm(PasswordVerificationMixin, UserForm):
    ...
    oldpassword = PasswordField(label=_("Current Password"),required=True,widget=forms.TextInput(attrs={
            "class": "form-control",
        }))
    password1 = SetPasswordField(label=_("New Password"),required=True,widget=forms.TextInput(attrs={
            "class": "form-control",
        }))
    password2 = PasswordField(label=_("New Password (again)"),required=True,widget=forms.TextInput(attrs={
            "class": "form-control",
        }))
